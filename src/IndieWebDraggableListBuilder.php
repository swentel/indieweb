...
/**
 * Defines a class to build a draggable listing of entities.
 */
abstract class IndieWebDraggableListBuilder extends EntityListBuilder implements FormInterface {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    foreach ($form_state->getValue($this->entitiesKey) as $id => $value) {
      if (isset($this->entities[$id]) && $this->entities[$id]->get($this->weightKey)->value != $value['weight']) {
