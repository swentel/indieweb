...
namespace Drupal\indieweb\XRay;

use p3k\XRay\Formats\Mf2;
use p3k\XRay\Formats\Mf2Feed;

class DrupalParseMf2 extends Mf2 {
  ...
  private static function parseAsHEntry($mf2, $item, $http, $url) {
    ...
    self::collectArrayURLValues(['follow-of', 'photo','video','audio','syndication','in-reply-to','like-of','repost-of','bookmark-of','quotation-of'], $item, $data, $refs, $http);
