...
class MicroformatSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['classes']['other'] = [
      ...
      '#markup' => 'To add "p-category" classes on tags, you can use the "Label link with p-category class" formatter.<br />To add "u-like-of", "u-bookmark-of", "u-in-reply-to" (use in reply, rsvp) "u-repost-of" on links, use the "Microformat link" formatter.<br />To add the "p-rsvp" class, use the "Microformat RSVP/Geocache" formatter. For more information about RSVP, go to the Micropub configuration screen for RSVP so you know what kind of field you need to create.<br />To add the "p-geocache-log-type" class, use the "Microformat RSVP/Geocache" formatter. For more information about Geoache, go to the Micropub configuration screen for Geocache so you know what kind of field you need to create.<br />To add (basic) checkin markup, use the Microformat checkin formatter on a link field. On that formatter, you can also select the geofield for latitude and longitude.<br />To add (basic) geo markup, use the Microformat Geo formatter on a geofield field. This can serve as an example how to markup up geo information.',
