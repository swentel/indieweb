...
class WebSubSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['general']['pages'] = [
      ...
      '#description' => $this->t('Specify pages by using their paths to which people can subscribe to. Enter one path per line. The \'*\' character is a wildcard. Enter &lt;front&gt; is the frontpage.'),
      '#required' => TRUE,
    ];
